      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action="/user/sign" method="post">
            
               <div class="form-label-group">
                <input type="text" id="inputText" name="userId" class="form-control" placeholder="LoginId" required autofocus>
              ...
              <div class="form-label-group">
                <input type="text" id="inputName" name="userName" class="form-control" placeholder="LoginId" required >
              ...
              <label class="custom-control-label">
                <input type="checkbox" class="custom-control-input" name="loginCookie">
