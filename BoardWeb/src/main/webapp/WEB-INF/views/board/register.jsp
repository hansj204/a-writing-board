	...
	<div class="container">
		<div class="row">
			<div class="card card-signin">
				<div class="card-body">
					<h5 class="card-title text-center" >게시물 등록</h5>
					<form class="form-signin" action="/board/register" method="post">
						<label>번호</label>
				     ...
				     <button type="submit" class="btn btn-primary">게시물 저장</button>
				       <button type="reset" class="btn btn-primary">게시물 초기화</button>
